...
/**
 * @brief 
 *  vector<FileNodeListFragment> FileNodeListFragments;
    FileNode ObjectSpaceManifestRoot;
    vector<FileNode> FileNodeSequence;
    vector<ObjectSpaceManifestList> ObjectSpaceManifestList;
    vector<FileNode> FileDataStoreListReference;
 */
