...
#include "../Structures/ExtendedGuid.hpp"

/**
 * @brief This class is used to represent the ObjectSpaceManifestRootFND structure.
 * 
 */
class ObjectSpaceManifestRootFND : public FileNodeBase {
    public:
        ...
        size_t Deserialize(char *pStart)
        {
            ...
            pIndex += gosidRoot.Deserialize(pIndex);
