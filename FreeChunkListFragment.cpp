...
#include <cstddef>
#include "./common/Structures/FreeChunkListFragment.hpp"

FreeChunkListFragment::FreeChunkListFragment(size_t len) {
    size = len;
};

size_t FreeChunkListFragment::Deserialize(char *pStart, size_t offset) {
